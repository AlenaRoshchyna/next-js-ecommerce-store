...
// first define the database that we want to connect to, otherwise you'll get a PostgresError, this lives inside the (...). If this is not done, the database is going to connect to my system 'alena'
